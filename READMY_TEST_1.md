...
1. Поскольку функция генерурирует пароль, предсказать значение конкретного пароля нельзя. 
Поэтому необходимо создать модули определенияв сгенерированном пароле:
